package com.cyber.generator.controller;
...
import com.cyber.generator.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"cyber.zip\"");
